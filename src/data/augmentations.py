...
def get_training_augmentation(image_size: tuple[int, int] | None = None) -> A.Compose:
    ...
    transforms.extend(
        [
            ...
            A.ShiftScaleRotate(
                shift_limit=0.0625, scale_limit=0.1, rotate_limit=10, border_mode=cv2.BORDER_CONSTANT, p=0.5
            ),
        ]
    )
        ...
        [
            ...
            A.OneOf(
                [
                    ...
                    A.RandomSunFlare(flare_roi=(0, 0, 1, 0.5), angle_lower=0.5, src_radius=100, p=1.0),
                ],
                p=0.2,
            ),
        ]
...
def get_training_augmentation_with_bbox(
    ...
    transforms.extend(
        [
            ...
            A.RandomSunFlare(flare_roi=(0, 0, 1, 0.5), angle_lower=0.5, src_radius=100, p=0.2),
        ]
    )
