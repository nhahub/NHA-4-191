...
class TestTrainingAugmentation:
    ...
    def test_training_augmentation_with_bbox(self, dummy_image, dummy_bboxes, dummy_labels):
        ...
        result = transform(image=dummy_image, bboxes=dummy_bboxes, class_labels=dummy_labels)
...
class TestAugmentationPresets:
    ...
    def test_preset_structure(self):
        required_keys = ["horizontal_flip_p", "shift_scale_rotate_p", "brightness_contrast_p", "weather_p"]
